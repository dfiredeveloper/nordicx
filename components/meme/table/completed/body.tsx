    ...
    return tokens.map((token, index) => (
        <tr key={index}>
                        <td className="py-3 px-2 sticky z-[1] left-0 bg-accent-2 ">
                            {/* token */}
                            <Link role="button" className="flex items-center md:w-[290px] w-[136px] md:flex-[290px] flex-[136px]" href={{ pathname: `/${chain}/token/${token.contract_address}`, query: { data: encodeURIComponent(JSON.stringify(token)) } }}>
