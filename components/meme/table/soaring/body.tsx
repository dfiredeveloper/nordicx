        ...
        return (
            <tr key={index}>
                <td className="py-3 px-2 sticky z-[1] left-0 bg-accent-2 ">
                    {/* token */}
                            <Link role="button" className="flex items-center md:w-[321px] w-[136px] md:flex-[321px] flex-[136px]" href={{ pathname: `/${chain}/token/${token.contract_address || token.address || (token.baseToken && token.baseToken.address) || ''}`, query: { data: encodeURIComponent(JSON.stringify(token)) } }}>
