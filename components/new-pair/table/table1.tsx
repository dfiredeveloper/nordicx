...
export default function Table() {
    return (
        <div className='w-full px-[1.3rem] h-[781px] gap-5 overflow-y-auto relative'>
            <div className="relative overflow-auto h-full">
                <table className="bg-white">
                    ...
                    <tbody className="text-[14px] divide-y">
                        {Array(40).fill(0).map((_, index) => <tr key={index}>
                            <td className="py-3 px-2 sticky z-[1] left-0 bg-white ">
                                {/* token */}
                                <a role="button" className="flex items-center md:w-[290px] w-[190px] md:flex-[290px] flex-[190px]" href="/eth/token/0xaec613188b1e178d42a05d352044d54854c3196a">
                                    <div className="flex items-center gap-2">
                                        <div className=""><svg xmlns="http://www.w3.org/2000/svg" width="16px" height="16px" fill="#AEB2BD" viewBox="0 0 16 16"><g clip-path="url(#clip0_6939_489)"><path fill-rule="evenodd" clip-rule="evenodd" d="M6.421.99a1.754 1.754 0 013.158 0l1.587 3.127 3.352.603c1.414.254 1.976 2.051.975 3.121l-2.37 2.536.484 3.5c.204 1.477-1.267 2.587-2.554 1.93L8 14.245l-3.053 1.56c-1.287.658-2.758-.452-2.554-1.929l.484-3.5L.507 7.84c-1-1.07-.439-2.867.975-3.121l3.352-.603L6.421.99z"></path></g><defs><clipPath id="clip0_6939_489"><rect width="16" height="16"></rect></clipPath></defs></svg></div>
                                        <div className="flex items-center gap-1">
                                            <div className="rounded-full border w-fit relative">
                                                <Image src={"/static/3717.png"} className='w-[30px] h-[30px]' width={35} height={35} alt='' />
                            ...
                            <td className="py-3 px-2">
                                {/* age */}
                                <div className="flex w-[107px] flex-[107px]">
                            ...
                            <td className="py-3 px-2">
                                ...
                                <div className="w-[131px] flex-[131px]">
                            ...
                            <td className="py-3 px-2">
                                ...
                                <div className="w-[96px] flex-[96px]">
                            ...
                            <td className="py-3 px-2 sticky right-0 z-[1] bg-white">
                                <div className="md:w-[111px] md:flex-[111px] w-[80px] flex-[80px]">
