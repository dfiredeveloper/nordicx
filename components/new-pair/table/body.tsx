            ...
            {Array(40).fill(0).map((_, index) => <tr key={index}>
                ...
                <td className="py-3 px-2">
                    ...
                    <div className="md:w-[131px] w-[84px] md:flex-[131px] flex-[84px]">
                        <div className="flex items-center gap-1">
                            <span>{formatNumber(123500)}</span>
                            <span>🔥</span>
                        </div>
                        <div className="text-[#ff9839] text-[12px]">${formatNumber(3050000)}</div>
                    </div>
                </td>
                ...
                <td className="py-3 px-2">
                    {/* mrk cap  < 100k -6e727d > 100k -158fff > 1m -ff9839 */}
                    <div className="md:w-[96px] w-[84px] md:flex-[96px] flex-[84px] flex gap-1">
                        ...
                        <div className="text-[#9AA0AA]">${formatNumber(3050000)}</div>
                    </div>
                </td>
                ...
                <td className="py-3 px-2">
                    {/* 1m txs */}
                    <div className="md:w-[96px] w-[84px] md:flex-[96px] flex-[84px]">
                        <div className="dark:text-white text-[13px]">3,500</div>
