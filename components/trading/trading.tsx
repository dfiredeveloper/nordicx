                            ...
                            <div className="flex items-center gap-2">
                                <div className="flex items-center gap-1">
                                    <div className="rounded-full border w-fit relative">
                                        ...
                                        <Image src={tokenData.chain === 'sol' || tokenData.chain === 'solana' ? "/static/solana.webp" : "/static/ether.webp"} className='md:min-w-[15px] min-w-[10px] md:h-[15px] h-[10px] absolute bottom-0 right-0' width={15} height={15} alt={tokenData.chain || ''} />
                                    </div>
                                    <div className="">
                                        {/* meme name */}
                                        <div className="flex items-center gap-1">
                                        ...
                                        <div className="flex items-center gap-1">
                                            <div className="text-[#9AA0AA] text-[12px]">{tokenData.age || '--'}</div>
                                            <TooltipProvider>
                                                <Tooltip>
                                                    <TooltipTrigger>
                    ...
                    <div className="flex items-center text-[12px] text-[400] gap-3">
                        <div className="space-y-1">
                            ...
                            <div className="flex items-center gap-1">
                                ...
                                <div className="flex items-center text-[13px]">
                                    <span>{tokenData.sniperCount || 0}</span>
                                    <span>/</span>
                                    <span>{tokenData.sniperTotal || 70}</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="space-y-1">
                            ...
                            <div className="flex items-center gap-1">
                                ...
                                <p className="text-[13px]">{tokenData.bluechipPercent || '1.2%'}</p>
                            </div>
                        </div>
