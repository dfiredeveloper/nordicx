...
export default function TradingHeader({ tokenData }: { tokenData: TokenData | null }): React.JSX.Element {
                            ...
                            <div className="flex items-center gap-2">
                                <div className="flex items-center gap-1">
                                    <div className="rounded-full border w-fit relative">
                                        ...
                                        <Image 
  src={tokenData.chain === 'sol' || tokenData.chain === 'solana' ? "/static/solana.webp" : "/static/ether.webp"} 
  className='md:min-w-[15px] min-w-[10px] md:h-[15px] h-[10px] absolute bottom-0 right-0' 
  width={15} 
  height={15} 
  alt={tokenData?.chain ? `${tokenData.chain} logo` : 'blockchain-logo'}
  unoptimized
/>
                                    </div>
                                    <div className="">
                                        ...
                                        <div className="flex items-center gap-1">
                                            <div className="flex gap-1 items-center">
                                                <h1 className="uppercase md:text-[14px] text-[13px] font-[400]">{tokenData.name || '--'}</h1>
                                                <TooltipProvider >
                                                    <Tooltip>
                                                        <TooltipTrigger>
                                                            <p className='text-[12px] text-accent-1'>{tokenData.symbol || '--'}</p>
                                                        </TooltipTrigger>
                                                        <TooltipContent className='bg-accent-3 text-[#111111] text-[12px] font-[400]'>
                                                            <p className="">{tokenData.name || '--'}</p>
                                                        </TooltipContent>
                                                    </Tooltip>
                                                </TooltipProvider>
                                            </div>
                                            <div className="flex gap-1">
                                                ...
                                                {/* dexscreener */}
                                                {tokenData.address && (
                                                    <a href={`https://dexscreener.com/${tokenData.chain || 'ethereum'}/${tokenData.address}`} className="md:block hidden">
                                        ...
                                        <div className="flex items-center gap-1">
                                            <div className="text-[#9AA0AA] text-[12px]">{String(tokenData?.age || '--')}</div>
                                            <TooltipProvider>
                                                <Tooltip>
                                                    <TooltipTrigger>
                                            ...
                                            {tokenData.address && (
                                                <div className="md:flex hidden items-center gap-1">
                                                    <p className='text-accent-aux-1 text-[12px]'>{truncAddress(tokenData.address)}</p>
                                                    <button onClick={() => tokenData.address && copyToClipboard(tokenData.address)}>
                                            ...
                                            {/* Twitter, Website, Telegram, Chain, Share */}
                                            {tokenData.twitter && (
                                                <a href={tokenData.twitter} target='_blank' className="hidden md:block text-accent-aux-1">
                                            ...
                                            {tokenData.website && (
                                                <a href={tokenData.website} target='_blank' className="hidden md:block text-accent-aux-1">
                                            ...
                                            {tokenData.telegram && (
                                                <a href={tokenData.telegram} target='_blank' className="hidden md:block text-accent-aux-1">
                ...
                <div className="flex items-center">
                    <div className="flex flex-col mr-[16px]">
                        <div className="flex h-[24px] text-[16px] font-[500] text-gRed">${tokenData.price?.toFixed(8) || '--'}</div>
                        <div className="flex w-full justify-end items-center gap-1 text-[12px]">
                          <p className='text-accent-aux-1'>24h Vol</p>
                          <p className='text-gGreen'>
                            {tokenData.volume_24h !== undefined ? `$${formatNumber(tokenData.volume_24h)}` : '--'}
                          </p>
                        </div>
                    </div>
                    ...
                    <div className="flex items-center text-[12px] text-[400] gap-3">
                        <div className="space-y-1">
                            ...
                            <div className="flex items-center gap-1">
                                ...
                                <div className="flex items-center text-[13px]">
                                    <span>{String(tokenData?.sniperCount || 0)}</span>
                                    <span>/</span>
                                    <span>{String(tokenData?.sniperTotal || 70)}</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="space-y-1">
                            ...
                            <div className="flex items-center gap-1">
                                ...
                                <p className="text-[13px]">{String(tokenData?.bluechipPercent || '1.2%')}</p>
                            </div>
                        </div>
                        ...
                        <div className="space-y-1">
                            ...
                            <div className="flex items-center gap-1">
                                <div className="flex text-[13px] items-center text-accent-green">
                                    {String(tokenData?.top10Percent || '12.5%')}
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="flex items-center gap-1">
                                <div className="flex items-center">
                                    <div className="flex items-center gap-1 text-[13px]">
                                        ...
                                        <p className='text-accent-green'>{tokenData.auditStatus || 'Safe'}</p>
                                        <p className='h-[18px] min-w-[30px] text-accent-green text-center text-[12px] rounded-[4px] bg-[rgba(136,214,147,0.2)]'>{tokenData.auditScore || '4/4'}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
