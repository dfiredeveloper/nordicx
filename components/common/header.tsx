                ...
                <div className="flex items-center gap-3">
                    <div className="flex gap-2 md:w-[250px] items-center">
                        <Select defaultValue={selectNetwork[1].ntwk}>
                            <SelectTrigger className="w-[130px] md:bg-white rounded-xl border-none outline-none ring-0">
                        ...
                        <button>
                            <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" fill="currentColor" viewBox="0 0 16 16"><path fill-rule="evenodd" clip-rule="evenodd" d="M7.5 2.8a4.7 4.7 0 100 9.4 4.7 4.7 0 000-9.4zM1.2 7.5a6.3 6.3 0 1112.6 0 6.3 6.3 0 01-12.6 0z"></path><path fill-rule="evenodd" clip-rule="evenodd" d="M10.934 10.934a.8.8 0 011.132 0l3 3a.8.8 0 11-1.132 1.132l-3-3a.8.8 0 010-1.132z"></path></svg>
                        </button>
                        <DropdownMenu>
                            <DropdownMenuTrigger>
                    ...
                    <button className='px-4 py-[0.4rem] rounded-md bg-[#292c33] text-xs font-[600] text-white'>Connect</button>
                </div>
            </div>
            <div className="bg-[#E4E4E4] border-t">
