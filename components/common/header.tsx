            ...
            <div className='md:px-[1.3rem] px-[.5rem] h-[56px] flex items-center gap-5 justify-between w-full'>
                ...
                <div className="relative max-w-[440px] w-full md:flex mx-[24px] hidden">
                    <div className="w-full relative h-[40px] rounded-lg overflow-hidden ">
                        ...
                        <input type="text" onFocus={() => setTriggerForInputDrpDown(true)} onBlur={() => setTriggerForInputDrpDown(false)} className='w-full h-full pl-8 placeholder:opacity-50 outline-none text-xs' placeholder='Search token/contract/wallet' />
                    ...
                    {/* drop down */}
                    {!!triggerInputDrop && <div className="absolute w-full bg-white rounded-md left-0 top-[50px] p-3 h-[400px] overflow-y-auto scroll-smooth">
                                        ...
                                        <div className="flex gap-2">
                                            ...
                                            <div className="flex items-center gap-2">
                                                ...
                                                <div className="">
                                                    ...
                                                    <a href="" className='text-[13px] underline text-[#6E727D]'>{truncAddress("0x1i48j8hned98")}</a>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div className="flex items-center gap-3">
                    <div className="flex gap-2 md:w-[250px] items-center">
                        <Select defaultValue={selectNetwork[1].ntwk}>
                            <SelectTrigger className="md:w-[130px] w-[80px] p-0 md:bg-white rounded-xl border-none outline-none focus:ring-0">
                        ...
                        <Dialog>
                            <DialogTrigger>
                                <button className=''>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="15px" height="15px" fill="currentColor" viewBox="0 0 16 16"><path fill-rule="evenodd" clip-rule="evenodd" d="M7.5 2.8a4.7 4.7 0 100 9.4 4.7 4.7 0 000-9.4zM1.2 7.5a6.3 6.3 0 1112.6 0 6.3 6.3 0 01-12.6 0z"></path><path fill-rule="evenodd" clip-rule="evenodd" d="M10.934 10.934a.8.8 0 011.132 0l3 3a.8.8 0 11-1.132 1.132l-3-3a.8.8 0 010-1.132z"></path></svg>
                                </button>
                            </DialogTrigger>
                                                            ...
                                                            <div className="flex gap-2">
                                                                ...
                                                                <div className="flex items-center gap-2">
                                                                    ...
                                                                    <div className="">
                                                                        ...
                                                                        <a href="" className='text-[12px] underline text-[#6E727D]'>{truncAddress("0x1i48j8hned98")}</a>
                                                                    </div>
                                                                </div>
                                                            </div>
                        ...
                        <DropdownMenu>
                            <DropdownMenuTrigger>
                                <div className='hover:bg-white duration-150 h-[35px] w-[35px] flex justify-center items-center rounded-md'>
                                ...
                                <DropdownMenuItem>
                                    <div className="flex justify-between w-full items-center">
                                        ...
                                        <div className="rotate-[-90deg]">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="12px" height="12px" fill="#292C33" viewBox="0 0 16 16"><path fillRule="evenodd" clipRule="evenodd" d="M2.273 5.675a.933.933 0 011.32 0l4.674 4.674 4.673-4.674a.933.933 0 011.32 1.32L8.267 12.99 2.273 6.995a.933.933 0 010-1.32z"></path></svg>
                                        </div>
                                    </div>
                                </DropdownMenuItem>
                                <DropdownMenuItem>
                                    <div className="flex items-center justify-between w-full">
                                        ...
                                        <div className="">
                                            <Select>
                                                ...
                                                <SelectContent className='bg-[#e4e4e4]'>
                                                    {
                                                        language.map(({ lang }, i) => (
                    ...
                    <button className='md:px-4 px-2 py-[0.4rem] rounded-md bg-[#292c33] text-xs font-[600] text-white'>Connect</button>
                </div>
            </div>
            <div className="bg-[#E4E4E4] border-t w-full overflow-x-auto">
