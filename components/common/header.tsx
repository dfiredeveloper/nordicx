...
export default function Header() {
    ...
    return (
        <div className='px-[1.3rem] h-[56px] flex items-center justify-between w-full'>
            ...
            <div className="relative max-w-[440px] w-full flex mx-[24px]">
            ...
            <div className="flex items-center gap-3">
                <div className="flex gap-2 w-[250px] items-center">
                    <Select defaultValue={selectNetwork[0].ntwk}>
                        <SelectTrigger className="w-[130px] bg-white rounded-xl border-none outline-none ring-0">
