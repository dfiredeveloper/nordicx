...
export default function Icon() {
    return new ImageResponse(
        (
            ...
            // <Image src="/favicon.svg" className='' width={size.width} height={size.height} alt='icon'/>

            <svg width={size.width} height={size.height} viewBox="0 0 307 245" fill="none" xmlns="http://www.w3.org/2000/svg">
